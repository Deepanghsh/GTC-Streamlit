...
plt.subplot(2,2,1)
nx.draw(K5, with_labels=True, node_size=800)
...
plt.subplot(2,2,3)
nx.draw(P5, with_labels=True, node_color="red", node_size=800)
...
nx.draw(K23,pos, with_labels=True, node_color="red", node_size=800)
